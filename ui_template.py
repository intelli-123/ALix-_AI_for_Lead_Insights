...
<head>
  ...
  <title>SAGE-Sales AI for Guidance and Engagement</title>
...
<body class="chat-container">
  <div class="chat-panel">
    <div class="chat-box">
      <div class="flex items-center justify-between text-2xl font-bold text-gray-800 dark:text-gray-200 mb-6 border-b pb-4 border-gray-200 dark:border-gray-700">
        <span class="italic text-red-800 dark:text-indigo-400 cursor-default">
          SAGE-Sales AI for Guidance and Engagement
        </span>
    ...
    <div class="logo-panel">
      <img src="/static/logo_2.png" alt="SAGE Logo" class="w-auto h-50 mb-2">
      <h2 class="italic text-3xl font-bold mb-2 transition-transform duration-300 ease-in-out hover:scale-105 cursor-default">SAGE</h2>
  ...
  <footer class="text-center text-xs text-slate-600 dark:text-slate-400 mt-6 mb-3">
    SAGE - Sales AI for Guidance and Engagement © 2025
  </footer>
